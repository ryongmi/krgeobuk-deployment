// portal-client CI/CD 파이프라인 Job 정의
// 수동 실행: Build with Parameters → ENVIRONMENT, GIT_BRANCH 선택

def githubOrg = System.getenv('GITHUB_ORG') ?: 'your-org'

pipelineJob('portal-client-pipeline') {
    description('portal-client CI/CD 파이프라인 (Next.js 포털 클라이언트)')
    ...
    definition {
        cpsScm {
            ...
            scriptPath('jenkins/Jenkinsfile.portal-client')
        }
    }
}
