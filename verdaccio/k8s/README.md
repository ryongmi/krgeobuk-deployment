...
├── ingress.yaml            # verdaccio.krgeobuk.com
...
```bash
# @krgeobuk 스코프만 Verdaccio 사용, 나머지는 npm 공식 레지스트리
...
npm publish --registry https://verdaccio.krgeobuk.com
```
...
```bash
# 로그인 상태 확인
npm whoami --registry https://verdaccio.krgeobuk.com
...
# Verdaccio에 패키지 존재 여부 확인
curl https://verdaccio.krgeobuk.com/@krgeobuk/core
```
...
```
192.168.0.28 verdaccio.krgeobuk.com
```
